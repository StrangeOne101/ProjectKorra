...
public class TempBlock {
	...
	private static final TreeSet<TempBlock> REVERT_QUEUE = new TreeSet<>((t1, t2) -> (int) (t1.revertTime - t2.revertTime));
	...
	public static class TempBlockRevertTask implements Runnable {
		...
		public void run() {
			...
			while (!REVERT_QUEUE.isEmpty()) {
				final TempBlock tempBlock = REVERT_QUEUE.first(); //Check if the top TempBlock is ready for reverting
