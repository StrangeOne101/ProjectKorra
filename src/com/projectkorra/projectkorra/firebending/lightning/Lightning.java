...
public class Lightning extends LightningAbility {
	...
	public Lightning(final Player player) {
		...
		this.selfHitWater = getConfigSection().getBoolean("SelfHitWater");
		this.selfHitClose = getConfigSection().getBoolean("SelfHitClose");
		this.arcOnIce = getConfigSection().getBoolean("ArcOnIce");
		...
		this.maxArcAngle = getConfigSection().getDouble("MaxArcAngle");
		this.subArcChance = getConfigSection().getDouble("SubArcChance");
		this.chainRange = applyModifiersRange(getConfigSection().getDouble("ChainArcRange"));
		this.chainArcChance = applyModifiers(getConfigSection().getDouble("ChainArcChance"));
		this.waterArcRange = applyModifiers(getConfigSection().getDouble("WaterArcRange"));
		this.stunChance = applyModifiers(getConfigSection().getDouble("StunChance"));
		this.stunDuration = applyModifiers(getConfigSection().getDouble("StunDuration"));
		this.maxChainArcs = applyModifiers(getConfigSection().getInt("MaxChainArcs"));
		this.waterArcs = (int) applyModifiers(getConfigSection().getInt("WaterArcs"));
		...
		this.allowOnFireJet = getConfigSection().getBoolean("AllowOnFireJet");
