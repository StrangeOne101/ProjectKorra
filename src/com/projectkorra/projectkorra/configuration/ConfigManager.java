...
public class ConfigManager {
	...
	public static void configCheck(final ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Commands.Temp.Description.Update", "Updates the time a temporary element will expire. If the specified <Player> doesn't have the element, they will be given it.");
			...
			config.addDefault("Commands.Temp.Add.Success", "You are now a {element}{bender} &efor &c{time}&e.");
			config.addDefault("Commands.Temp.Add.SuccessAvatar", "You are now the Avatar for &c{time}&e.");
			config.addDefault("Commands.Temp.Add.SuccessOther", "{target} is now a {element}{bender} &efor &c{time}&e.");
			...
			config.addDefault("Commands.Temp.Extend.SuccessOther", "{target}'s {element}{bending} &ehas been extended and will expire in &c{time}&e.");
			config.addDefault("Commands.Temp.Extend.Success", "Your {element} &ehas been extended and will now expire in &c{time}&e.");
			config.addDefault("Commands.Temp.Reduce.SuccessOther", "{target}'s {element} &eexpiry time has been reduced and will expire in &c{time}&e.");
			...
			config.addDefault("Commands.Temp.Update.SuccessOther", "{target}'s {element}{bending} &ehas been modified and now expires in &c{time}&e.");
			config.addDefault("Commands.Temp.Update.Success", "Your {element}{bending} &ehas been modified and will now expire in &c{time}&e.");
