...
public class WaterArms extends WaterAbility {
	...
	public WaterArms(final Player player) {
		...
		this.canUsePlantSource = getConfigSection().getBoolean("Arms.AllowPlantSource");
		this.lightningEnabled = getConfigSection().getBoolean("Arms.Lightning.Enabled");
		this.lightningKill = getConfigSection().getBoolean("Arms.Lightning.KillUser");
		this.initLength = getConfigSection().getInt("Arms.InitialLength");
		this.sourceGrabRange = getConfigSection().getInt("Arms.SourceGrabRange");
		this.maxPunches = getConfigSection().getInt("Arms.MaxAttacks");
		this.maxIceBlasts = getConfigSection().getInt("Arms.MaxIceShots");
		this.maxUses = (int) applyModifiers(getConfigSection().getInt("Arms.MaxAlternateUsage"));
		this.cooldown = applyInverseModifiers(getConfigSection().getLong("Arms.Cooldown"));
		this.lightningDamage = getConfigSection().getDouble("Arms.Lightning.Damage");
