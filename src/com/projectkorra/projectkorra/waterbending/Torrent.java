...
public class Torrent extends WaterAbility {
	...
	public Torrent(final Player player) {
		...
		this.layer = 0;
		this.startAngle = 0;
		this.maxLayer = getConfigSection().getInt("MaxLayer");
		this.knockback = applyModifiers(getConfigSection().getDouble("Knockback"));
		this.angle = getConfigSection().getDouble("Angle");
		this.radius = applyModifiers(getConfigSection().getDouble("Radius"));
		this.knockup = applyModifiers(getConfigSection().getDouble("Knockup"));
		this.interval = getConfigSection().getLong("Interval");
		this.damage = applyModifiers(getConfigSection().getDouble("InitialDamage"));
		this.successiveDamage = applyModifiers(getConfigSection().getDouble("SuccessiveDamage"));
		this.maxHits = getConfigSection().getInt("MaxHits");
		this.deflectDamage = applyModifiers(getConfigSection().getDouble("DeflectDamage"));
		...
		this.revertTime = getConfigSection().getLong("RevertTime");
