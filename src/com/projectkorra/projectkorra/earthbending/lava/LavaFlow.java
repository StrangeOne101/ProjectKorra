...
public class LavaFlow extends LavaAbility {
	...
	public LavaFlow(final Player player, final AbilityType type) {
		...
		this.revertMaterial = Material.getMaterial(getConfigSection().getString("RevertMaterial"));

		this.shiftCooldown = getConfigSection().getLong("ShiftCooldown");
		this.shiftPlatformRadius = getConfigSection().getDouble("ShiftPlatformRadius");
		this.shiftMaxRadius = getConfigSection().getDouble("ShiftRadius");
		this.shiftFlowSpeed = getConfigSection().getDouble("ShiftFlowSpeed");
		this.shiftRemoveSpeed = getConfigSection().getDouble("ShiftRemoveSpeed");
		this.shiftRemoveDelay = getConfigSection().getLong("ShiftCleanupDelay");
		this.particleDensity = getConfigSection().getDouble("ParticleDensity");
		this.clickRange = getConfigSection().getDouble("ClickRange");
		this.clickLavaRadius = getConfigSection().getDouble("ClickRadius");
		this.clickLandRadius = getConfigSection().getDouble("ClickRadius");
		this.clickLavaDelay = getConfigSection().getLong("ClickLavaStartDelay");
		this.clickLandDelay = getConfigSection().getLong("ClickLandStartDelay");
		this.clickLavaCooldown = getConfigSection().getLong("ClickLavaCooldown");
		this.clickLandCooldown = getConfigSection().getLong("ClickLandCooldown");
		this.clickLavaCleanupDelay = getConfigSection().getLong("ClickLavaCleanupDelay");
		this.clickLandCleanupDelay = getConfigSection().getLong("ClickLandCleanupDelay");
		this.lavaCreateSpeed = getConfigSection().getDouble("ClickLavaCreateSpeed");
		this.landCreateSpeed = getConfigSection().getDouble("ClickLandCreateSpeed");
		this.upwardFlow = getConfigSection().getInt("UpwardFlow");
		this.downwardFlow = getConfigSection().getInt("DownwardFlow");
		this.allowNaturalFlow = getConfigSection().getBoolean("AllowNaturalFlow");
